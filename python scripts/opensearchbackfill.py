...
# Run below command to execute this python file
"""
...
"""
example: python opensearchbackfill.py --rn 'us-east-1' --tn 'Organization-btyctx6r6vdfpan7uyip2xx5g4-dev' --lf 'arn:aws:lambda:us-east-1:437326140083:function:amplify-idawebapp-dev-170-OpenSearchStreamingLambd-rBaLBJE6zshc' --esarn 'arn:aws:dynamodb:us-east-1:437326140083:table/Organization-btyctx6r6vdfpan7uyip2xx5g4-dev'
"""